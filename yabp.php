...
/*  
    Copyright 2014-2016  Mitchel Troost  (email: mitchel.troost@gmail.com)
        ...
        if (substr_count($output, "200 OK") > 0) {
            ...
            foreach ($phpobject->Products as $item) {
                ...
                if ($item_rating != "") {
                    ...
                    $item_ratingspan = '<span class="rating"><img alt="'.sprintf(__('Score %1$.1f out of 5 stars.', 'yabp'), $altrating).'" title="'.sprintf(__('Score %1$.1f out of 5 stars.', 'yabp'), $altrating).'" src="'.plugin_dir_url( __FILE__ ).'img/icons/'. $nicerating . '.png"></span>';
                } 
            ...
            if (substr_count($output, "200 OK") > 0) {
                ...
                foreach ($phpobject->Products as $item) {                
                    ...
                    if ($rating != "") {
                        ...
                        if (strlen($nicerating) < 2) { $nicerating .= ".0"; } 
                        $nicerating = str_replace(".", "_", $nicerating);                    
                        $ratingspan = '<span class="rating"><img alt="'.sprintf(__('Score %1$.1f out of 5 stars.', 'yabp'), $altrating).'" title="'.sprintf(__('Score %1$.1f out of 5 stars.', 'yabp'), $altrating).'" src="'.plugin_dir_url( __FILE__ ).'img/icons/'. $nicerating . '.png"></span>';
                    } 
                    else { $ratingspan = ''; }
